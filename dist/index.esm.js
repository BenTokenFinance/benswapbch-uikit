...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$B, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$C, { width: "24px", color: "textSubtle" }))),
